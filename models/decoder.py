# models/decoder.py - Unidirectional LSTM (Supercharged - NO CHEATING)
...
class GapDecoder(nn.Module):
    ...
    """
    def __init__(self, context_dim=512, hidden_size=1024, vocab_size=4):
        super().__init__()
    ...
    def forward(self, ctx, tgt_in):
        ...
        # LSTM forward
        lstm_out, _ = self.lstm(embedded, (h0, c0))  # [batch, seq_len, hidden_size]
