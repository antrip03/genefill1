# train_mlm_all_genomes.py
# RUN SEQUENTIALLY FOR 7 DATASETS
...
print("=" * 70)
print("BERT-STYLE MASKED DNA TRAINING (ENCODER ONLY) – ALL GENOMES")
print("=" * 70)
...
# ---------------------------------------------------------------------
# Device + multi-GPU (same logic as your file)
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# List of datasets and output checkpoints
...
def collate_fn(batch):
    # EXACTLY THE SAME collate_fn AS IN YOUR KLEBSIELLA SCRIPT
...
def train_one_dataset(label, data_path, save_path):
    print()
    print("=" * 70)
    print(f"TRAINING DATASET: {label}")
    print("=" * 70)
    ...
    # -----------------------------------------------------------------
    # Model / Optimizer (same as your script)
    # -----------------------------------------------------------------
    ...
    # -----------------------------------------------------------------
    # Training loop (exactly your loop, unchanged)
    # -----------------------------------------------------------------
    print("=" * 70)
    print(f"TRAINING START (MASKED LM) – {label}")
    print("=" * 70)
...
if __name__ == "__main__":
    for label, data_path, save_path in DATASETS:
        train_one_dataset(label, data_path, save_path)
